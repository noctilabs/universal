...
export type Booking = {
  ...
  booking_line_items: Array<Maybe<BookingLineItem>>;
...
export type BookingResourceStatusEnum =
  | 'draft'
  | 'published';
...
export type BookingResource = {
  ...
  id: Scalars['ID']['output'];
  booking_resource_availability_rules: Array<Maybe<BookingResourceAvailabilityRule>>;
  booking_resource_allocations: Array<Maybe<BookingResourceAllocation>>;
  booking_resource_pricing_configs: Array<Maybe<BookingResourcePricingConfig>>;
  product_id: Scalars['String']['output'];
  status: BookingResourceStatusEnum;
...
export type BookingRuleScopeEnum =
  | 'global'
  | 'resource';
...
export type BookingRule = {
  ...
  name: Scalars['String']['output'];
  description: Maybe<Scalars['String']['output']>;
  scope: BookingRuleScopeEnum;
  booking_resource_ids: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  require_payment: Scalars['Boolean']['output'];
  require_confirmation: Scalars['Boolean']['output'];
  reservation_ttl_seconds: Scalars['Int']['output'];
...
export type BookingResourceAllocation = {
  __typename?: 'BookingResourceAllocation';
  booking_cart_item: BookingCartItem;
  booking_line_item: BookingLineItem;
  id: Scalars['ID']['output'];
  booking_cart_item_id: Maybe<Scalars['String']['output']>;
  booking_line_item_id: Maybe<Scalars['String']['output']>;
  booking_resource_id: Scalars['String']['output'];
  booking_resource: BookingResource;
  start_time: Scalars['DateTime']['output'];
  end_time: Scalars['DateTime']['output'];
  expires_at: Maybe<Scalars['DateTime']['output']>;
  status: BookingResourceAllocationStatusEnum;
...
export type BookingCartItemStatusEnum =
  | 'reserved'
  | 'expired'
  | 'converted';

export type BookingCartItem = {
  __typename?: 'BookingCartItem';
  id: Scalars['ID']['output'];
  cart_id: Scalars['String']['output'];
  cart_line_item_id: Scalars['String']['output'];
  ...
  status: BookingCartItemStatusEnum;
  expires_at: Maybe<Scalars['DateTime']['output']>;
  metadata: Maybe<Scalars['JSON']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
...
export type BookingResourceAllocationStatusEnum =
  | 'hold'
  | 'reserved'
  | 'confirmed'
  | 'cancelled';

export type BookingResourceAvailabilityRuleEffectEnum =
  | 'available'
  | 'unavailable';

export type BookingResourceAvailabilityRule = {
  __typename?: 'BookingResourceAvailabilityRule';
  id: Scalars['ID']['output'];
  booking_resource_id: Scalars['String']['output'];
  booking_resource: BookingResource;
  rule_type: Scalars['String']['output'];
  name: Scalars['String']['output'];
  description: Maybe<Scalars['String']['output']>;
  effect: BookingResourceAvailabilityRuleEffectEnum;
  priority: Scalars['Int']['output'];
  valid_from: Maybe<Scalars['DateTime']['output']>;
  valid_until: Maybe<Scalars['DateTime']['output']>;
  configuration: Scalars['JSON']['output'];
...
export type BookingResourcePricingConfigUnitEnum =
  | 'second'
  | 'minute'
  | 'hour'
  | 'day'
...
export type BookingResourcePricingConfig = {
  __typename?: 'BookingResourcePricingConfig';
  id: Scalars['ID']['output'];
  product_variant_id: Scalars['String']['output'];
  booking_resource_id: Scalars['String']['output'];
  booking_resource: BookingResource;
  unit: BookingResourcePricingConfigUnitEnum;
  unit_value: Scalars['Int']['output'];
  product_variant_title: Maybe<Scalars['String']['output']>;
  metadata: Maybe<Scalars['JSON']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    booking_cart_item: BookingCartItem
    booking_cart_items: BookingCartItem
    booking_line_item: BookingLineItem
    booking_line_items: BookingLineItem
    booking_resource_allocation: BookingResourceAllocation
    booking_resource_allocations: BookingResourceAllocation
    booking_resource_availability_rule: BookingResourceAvailabilityRule
    booking_resource_availability_rules: BookingResourceAvailabilityRule
    booking_resource_pricing_config: BookingResourcePricingConfig
    booking_resource_pricing_configs: BookingResourcePricingConfig
    cart: Cart
    carts: Cart
