import type BookingModule from '@rsc-labs/medusa-booking-system/.medusa/server/src/modules/booking'
...
import type Sanity from '../../src/modules/sanity'

declare module '@medusajs/framework/types' {
  interface ModuleImplementations {
    'bookingModule': InstanceType<(typeof BookingModule)['service']>,
    ...
    'sanity': InstanceType<(typeof Sanity)['service']>
  }
}