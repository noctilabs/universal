  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p style={{ margin: 0 }}>
            Universal abre únicamente con agenda previa. Por consultas o para agendar una visita, escribí a:{" "}
          </p>
          <a
            href="mailto:hola@esuniversal.uy"
            style={{
              color: "#000",
              fontWeight: 500,
              textDecoration: "none",
        ...
        >
          ...
          >
            Piedras 544, Montevideo, Uruguay.
          </p>
        </div>
        ...
        <div>
          <a
            href="https://www.instagram.com/esuniversal"
            target="_blank"
